...
(defun nibelung-theme-create (theme-name palette)
  ...
  (let* ((bg                  (plist-get palette :bg))
         ...
         (_accent-subtle      (plist-get palette :_accent-subtle))
    ...
    (custom-theme-set-faces
     ...
     `(cursor ,cursor)
     `(highlight ,highlight)
     `(hl-line ((t (:background ,level0 :extend t))))
     ...
     `(window-divider ((t (:foreground ,level0))))
     `(window-divider-first-pixel ((t (:foreground ,level0))))
     `(window-divider-last-pixel ((t (:foreground ,level0))))
     `(vertical-border ((t (:foreground ,level0))))
     `(escape-glyph ((t (:foreground ,level4))))
     `(file-name-shadow ,optional)
     `(button ,link)
     `(link-visited ((t (:foreground ,level4 :underline t))))
     ;; Syntax: global defaults (safe for all modes)
     `(font-lock-builtin-face ,builtin)
     `(font-lock-preprocessor-face ,builtin)
     ...
     `(font-lock-string-face ,optional)
     `(font-lock-delimiter-face ,optional)
     `(font-lock-type-face ,builtin)
     `(font-lock-function-name-face ,optional)
     `(font-lock-variable-name-face ,builtin)
     `(font-lock-bracket-face ,optional)
     `(tree-sitter-hl-face:string ,optional)
     `(tree-sitter-hl-face:string.delimiter ,optional)
     `(tree-sitter-hl-face:property ,optional)
     `(tree-sitter-hl-face:keyword ,constant)
     ...
     `(eglot-inlay-hint-face ((t (:foreground ,level1 :slant italic))))
     ...
     `(corfu-deprecated ((t (:foreground ,level4 :strike-through t))))
     `(corfu-echo ((t (:foreground ,level3))))
     `(corfu-indexed ((t (:foreground ,level3 :background ,level1 :height 0.75))))
     `(corfu-popupinfo ((t (:background ,level0))))
     `(corfu-quick1 ((t (:foreground ,emphasis :background ,level1 :weight bold))))
     `(corfu-quick2 ((t (:foreground ,rainbow-magenta :background ,level1 :weight bold))))
