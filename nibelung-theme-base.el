...
(defun nibelung-theme-create (theme-name palette)
  ...
  (let* ((bg                  (plist-get palette :bg))
         ...
         (code-block `((t (:inherit default :extend t :background ,level0 :weight normal))))
         (code-block-header `((t (:inherit default :extend t :background ,level1 :foreground ,fg :weight normal))))
         ...
         (header-not-extended `((t (:inherit default :extend nil :background ,level4 :foreground ,level0 :weight normal))))
     ...
     ;; Warnings
         ...
         `(warning ,header)
         `(error ,header)
         `(flymake-error ((t (:inherit default :extend t :background ,emphasis :foreground ,fg))))
         `(flymake-warning ((t (:inherit default :underline (:color ,emphasis :style line :position t)))))
     ;; Modeline
     ...
     ;; Magit
      ...
      ;; Transient
         ...
         `(transient-inactive-value ,level3)
         `(transient-inapt-argument ,level3)
         `(transient-inapt-suffix ,level3)
         `(transient-key ,text)
         `(transient-key-noop ,level3)
         `(transient-key-recurse ,bold)
         `(transient-key-return ,bold)
         `(transient-key-stack ,emphasis)
         `(transient-mismatched-key ,level5)
         `(transient-nonstandard-key ,level4)
         `(transient-unreachable ,level3)
         `(transient-unreachable-key ,level3)
     ;; Treesitter
      ...
      ;; Cider
         ...
         `(cider-deprecated-face ,level4)
         `(cider-docview-emphasis-face ,emphasis)
         `(cider-docview-literal-face ,constant)
         `(cider-docview-strong-face ,bold)
         `(cider-docview-table-border-face ,level3)
         `(cider-enlightened-face ,match)
         `(cider-enlightened-local-face ,emphasis)
         `(cider-error-highlight-face ,header)
         `(cider-fragile-button-face ,level4)
         `(cider-fringe-good-face ,match)
         `(cider-reader-conditional-face ,level4)
         `(cider-repl-input-face ,bold)
         `(cider-repl-prompt-face ,code-block-header)
         `(cider-repl-result-face ,level4)
         `(cider-repl-stderr-face ,level5)
         `(cider-repl-stdout-face ,level3)
         `(cider-stacktrace-error-class-face ,bold)
         `(cider-stacktrace-error-message-face ,level5)
         `(cider-stacktrace-face ,level3)
         ...
         `(cider-stacktrace-suppressed-button-face ,level3)
         `(cider-test-error-face ,level5)
         `(cider-traced-face ,emphasis)
         `(cider-warning-highlight-face ,level4)
         `(cider-browse-ns-extra-info-face ,level3)
     ;; Eshell
     ...
     ;; Diff-HL
      ...
      ;; Vertico
         ...
         `(vertico-posframe ,level0)
         `(vertico-posframe-border ,level2)
         `(vertico-posframe-border-2 ,level2)
         `(vertico-posframe-border-3 ,level2)
         `(vertico-posframe-border-4 ,level2)
         `(vertico-posframe-border-fallback ,level2)
     ...
     ;; Ediff
      ...
      ;; Corfu
         `(corfu--bar ,level2)
         `(corfu--cbar ,level2)
         `(corfu-annotations ,level3)
         `(corfu-bar ,level2)
         `(corfu-border ,level2)
         `(corfu-current ,match)
         `(corfu-default ,default)
         `(corfu-deprecated ,level4)
         `(corfu-popupinfo ,level0)

      ;; CUA
         `(cua-global-mark ,bold)
         `(cua-rectangle ,level4)
         `(cua-rectangle-noselect ,level2)
