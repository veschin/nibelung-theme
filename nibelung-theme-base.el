...
(defun nibelung-theme-create (theme-name palette)
  ...
  (let* ((bg                  (plist-get palette :bg))
    ...
    (custom-theme-set-faces
     ...
     `(org-table ,constant)
     ;; Dired
     `(dired-broken-symlink ,replace-match*)
     `(dired-directory ,constant)
     `(dired-flagged ,replace-confirm)
     ...
     `(diredfl-flag-mark ,match)
     `(diredfl-flag-mark-line ((t (:inherit default :extend t :background ,level0))))
     ...
     `(dirvish-hl-line ((t (:inherit default :background ,level0))))
     `(dirvish-hl-line-inactive ((t (:inherit default :background ,level0 :foreground ,level2))))
     `(dirvish-inactive ,optional)
     `(dirvish-media-info-heading ,code-block-header)
     `(dirvish-media-info-property-key ,constant)
     `(dirvish-proc-failed ,replace-match*)
